...
model.compile(
    ...
    metrics=[
        ...
        K.metrics.AUC(name='roc_auc', curve='ROC'),
        K.metrics.AUC(name='pr_auc', curve='PR')
    ]
)
model.summary()
...
callback = [
    ...
    K.callbacks.TensorBoard(log_dir=f'logs/{model_name}', write_graph=True, write_images=True)
]
